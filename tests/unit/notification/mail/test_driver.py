...
from poppy.notification.mail import driver
...
class TestDriver(base.TestCase):
    ...
    def test_init(self):
        self.assertTrue(self.mail_notification_driver is not None)

    def test_service_contoller(self):
        self.assertTrue(self.mail_notification_driver.services_controller
                        is not None)
