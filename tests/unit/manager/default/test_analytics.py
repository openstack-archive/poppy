...
class StorageResult(object):
    ...
    def __init__(self, provider_details=None):
...
class DefaultManagerServiceTests(base.TestCase):
    ...
    def setUp(self, mock_metrics, mock_bootstrap, mock_distributed_task,
        ...
        self.analytics_controller = \
            self.bootstrap_obj.manager.analytics_controller
        self.storage_controller = \
            self.bootstrap_obj.manager.st
    ...
    def test_analytics_get_metrics_by_domain_provider_details_None(self):
        ...
        extras = {}
        storage_controller = \
            self.bootstrap_obj.manager.analytics_controller._driver.storage
