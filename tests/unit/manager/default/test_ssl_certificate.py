...
class DefaultSSLCertificateControllerTests(base.TestCase):
    ...
    def test_create_ssl_certificate_exception_storage_create_cert(self):
        ...
        self.scc.storage_controller.create_cert.side_effect = ValueError(
    ...
    def test_update_san_retry_list(self):
        ...
        self.scc.storage_controller.get_certs_by_domain. \
        ...
        self.assertEqual(
            True,
            self.scc.storage_controller.get_certs_by_domain.called
        )
        self.assertEqual(
            True,
    ...
    def test_rerun_san_retry_list_exception_service_validation(self):
        ...
        self.scc.storage_controller.get_service_details_by_domain_name. \
            return_value = None
