...
class TestServices(base.TestCase):
    ...
    @ddt.data("SPS Request Complete", "edge host already created or pending")
    def test_create_ssl_certificate_happy_path(self, sps_status):
    ...
    def test_create_ssl_certificate_happy_path_2(self):
        self.driver.san_cert_cnames = ["secure.san1.poppycdn.com",
                                       "secure.san2.poppycdn.com"]
            ...
            text=json.dumps({
                "requestList":
                    [{"resourceUrl": "/config-secure-provisioning-service/"
                     ...
                     "lastStatusChange": "2015-03-19T21:47:10Z",
                        "spsId": 1789,
                        "status": "edge host already created or pending",
                        "workflowProgress": "All of your requested changes"
                                            " are complete.",
                        "jobId": 44306}]})
        )
        controller.sps_api_client.post.return_value = mock.Mock(
