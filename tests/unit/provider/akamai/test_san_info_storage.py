...
class TestSANInfoStorage(base.TestCase):
    ...
    def test__zk_path(self):
        path1 = self.zk_storage._zk_path('secure.san1.altcdn.com', 'jobId')
        self.assertTrue(path1 == '/san_info/secure.san1.altcdn.com/jobId')

        path2 = self.zk_storage._zk_path('secure.san1.altcdn.com', None)
        self.assertTrue(path2 == '/san_info/secure.san1.altcdn.com')

    def test__save_cert_property_value(self):
        self.zk_storage._save_cert_property_value('secure.san1.altcdn.com',
                                                  'spsId', 1789)
        self.zk_storage.zookeeper_client.ensure_path.assert_called_once_with(
            '/san_info/secure.san1.altcdn.com/spsId')
        self.zk_storage.zookeeper_client.set.assert_called_once_with(
            '/san_info/secure.san1.altcdn.com/spsId', 1789)

    def test_save_cert_last_spsid(self):
        self.zk_storage.save_cert_last_spsid('secure.san1.altcdn.com', 1789)
        self.zk_storage.zookeeper_client.ensure_path.assert_called_once_with(
            '/san_info/secure.san1.altcdn.com/spsId')
        self.zk_storage.zookeeper_client.set.assert_called_once_with(
            '/san_info/secure.san1.altcdn.com/spsId', 1789)
    ...
    def test_get_cert_last_spsid(self):
        self.zk_storage.get_cert_last_spsid('secure.san1.altcdn.com')
        self.zk_storage.zookeeper_client.ensure_path.assert_called_once_with(
            '/san_info/secure.san1.altcdn.com/spsId')
    ...
    def list_all_san_cert_names(self):
        ...
        self.zk_storage.zookeeper_client.get_children.assert_create_once_with(
            '/san_info/secure.san1.altcdn.com'
        )

    def test_get_cert_info(self):
        res = self.zk_storage.get_cert_info('secure.san1.altcdn.com')
        self.zk_storage.zookeeper_client.ensure_path.assert_called_once_with(
            '/san_info/secure.san1.altcdn.com'
        )
        calls = [mock.call('/san_info/secure.san1.altcdn.com/jobId'),
                 mock.call('/san_info/secure.san1.altcdn.com/issuer'),
                 mock.call('/san_info/secure.san1.altcdn.com/ipVersion'),
                 mock.call(
            '/san_info/secure.san1.altcdn.com/slot_deployment_klass')]
