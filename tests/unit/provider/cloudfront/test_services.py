...
class TestServices(base.TestCase):
    ...
    def test_get(self):
        ...
        self.assertIn('domains', resp[self.driver.provider_name])
        self.assertIn('origins', resp[self.driver.provider_name])
        self.assertIn('caching', resp[self.driver.provider_name])
