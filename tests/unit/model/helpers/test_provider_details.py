...
class TestProviderDetails(base.TestCase):
    ...
    def test_set_domain_certificate_status(self, status):
        self.my_provider_detail.set_domain_certificate_status(
            "www.ab.com", status)

        self.assertTrue(
            self.my_provider_detail.domains_certificate_status["www.ab.com"] ==
            status)
    ...
    def test_get_domain_certificate_status(self, status):
        current_status = (
            self.my_provider_detail.get_domain_certificate_status("www.ab.com")
        )
        self.assertTrue(
