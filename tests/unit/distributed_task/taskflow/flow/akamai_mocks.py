...
added_services_list = ['["000", "f81f4459-ae02-4e3b-b36e-e4917adfe945"]',
                       '["000", "4fe3fbab-a73f-459d-be8a-74f9ff82c147"]']
removed_services_list = []
...
class MockDistributedTaskServiceController(mock.Mock):
    ...
    def dequeue_all_papi_jobs(self):
        ...
        return [json.dumps({u'message': json.dumps(hosts_message),
                ...
                '"spsId": 1789, "jobID": 44434}, "j_type": "secureEdgeHost"}']
