...
class MockManager(mock.Mock):
    ...
    def providers(self):
        ...
        akamai_mock_provider_obj.service_controller = (
            MockAkamaiDriverServiceController())
...
class MockAkamaiDriverServiceController(mock.Mock):

    def dequeue_all_add_san_cert_service(self):
        res = added_services_list+removed_services_list
        res = [json.dumps(r) for r in res]
        return res
    ...
    def dequeue_all_papi_jobs(self):
        ...
        return [json.dumps({u'message': json.dumps(hosts_message),
                ...
                # services with one SPS check
                    ...
                    [json.dumps(service[1:]) for service
                     in added_services_list]],
                u'j_type': u'hosts'}),
    ...
    def dequeue_status_check_queue(self):
        return ({u'SPSStatusCheck': 1789,
                ...
                [service[1:] for service
                    in (added_services_list+removed_services_list)])
        # return ({u'SPSStatusCheck': 1789},
        #         [u'["secureEdgeHost", '
