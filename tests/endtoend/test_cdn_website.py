...
class TestWebsiteCDN(base.TestBase):
    ...
    def test_enable_cdn(self):
        ...
        resp = self.poppy_client.get_service(service_name=service_name)
        # TODO(malini) : Fix the access_url dict keys after the GET /service
        # HTTP 500 bug is fixed.
        access_url = resp.json()['links']['href']
