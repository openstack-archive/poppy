...
class TestWebsiteCDN(base.TestBase):
    ...
    def setUp(self):
        ...
        sub_domain = 'TestCDN-' + base.random_string()
    ...
    def test_enable_cdn(self):
        ...
        origin_list = [{"origin": self.origin,
                        ...
                        "ssl": False}]
        caching_list = []
        self.service_name = 'testService-' + base.random_string()
        ...
        self.setup_cname(name=self.test_domain, cname=access_url[0])
    ...
    def test_multiple_domains(self):
        ...
        sub_domain2 = 'TestCDN-' + base.random_string()
        ...
        self.setup_cname(name=self.test_domain, cname=access_url[0])
        self.setup_cname(name=self.test_domain2, cname=access_url[0])
