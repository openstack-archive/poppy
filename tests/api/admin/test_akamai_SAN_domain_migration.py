...
class TestSanCertService(base.TestBase):
    ...
    def test_migrate_in_progress_cert(self):
        ...
        resp = self.operator_client.get_ssl_certificate(domain_name=domain)
        san_cert = resp['cert_details']['Akamai']['extra_info']['san cert']
        self.assertEqual(san_cert, new_cert)
