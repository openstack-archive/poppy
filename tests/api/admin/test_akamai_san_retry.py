...
class TestGetSanRetryList(base.TestBase):
    ...
    def test_san_retry_list(self):
        ...
        self.operator_client.admin_put_san_retry_list(san_list=input_san_list)
    ...
    def test_san_retry_empty_list(self):
        san_list = []
        self.operator_client.admin_put_san_retry_list(san_list=san_list)
    ...
    def test_san_retry_list_update_order(self):
        ...
        self.operator_client.admin_put_san_retry_list(
        ...
        normalized_input_san_list_update_again = self.normalize_san_retry_list(
            san_list=input_san_list_update_again)
        self.assertEqual(
            san_retry_list, normalized_input_san_list_update_again)
