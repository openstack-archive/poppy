...
class PoppyClient(client.AutoMarshallingHTTPClient):
    ...
    def create_service(self, service_name=None,
        ...
        """
        url = '{0}/v1.0/{1}/services'.format(self.url, self.project_id)
    ...
    def patch_service(self, service_name=None, request_body=None,
        ...
        services/{service_name}
        """
        url = '{0}/v1.0/{1}/services/{2}'.format(self.url,
                                                 self.project_id,
                                                 service_name)
    ...
    def check_health(self):
        ...
        url = '{0}/v1.0/{1}/health'.format(self.url, self.project_id)
        return self.request('GET', url)
    ...
    def ping(self):
        ...
        url = '{0}/v1.0/{1}/ping'.format(self.url, self.project_id)
        return self.request('GET', url)
    ...
    def create_flavor(self, flavor_id=None, provider_list=None, limits=None,
        ...
        flavors/{flavor_id}
        """
        url = '{0}/v1.0/{1}/flavors'.format(self.url, self.project_id)
    ...
    def get_flavor(self, flavor_location=None, flavor_id=None):
        ...
        if flavor_location:
            ...
            url = '{0}/v1.0/{1}/flavors/{2}'.format(self.url,
                                                    self.project_id,
                                                    flavor_id)
    ...
    def delete_flavor(self, flavor_location=None, flavor_id=None):
        ...
        if flavor_location:
            ...
            url = u'{0}/v1.0/{1}/flavors/{2}'.format(self.url,
                                                     self.project_id,
                                                     flavor_id)
