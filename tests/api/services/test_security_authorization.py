...
class TestAuthorizationService(providers.TestProviderBase):
    ...
    without valid tokens or no token at all. It also check whether it is
    possible to create/patch/list/delete services of one user using another
    user's valid token. The supposed repsonses should be 401 errors.
    ...
    @ddt.file_data('data_create_service_one_complete.json')
    ...
    def test_authorization_create_service_other_user_token(self, test_data):
        """Check creating a servcie with another user's token."""
    ...
    def test_authorization_list_service_invalid_token(self):
        """Check listing all services with invlid token."""
    ...
    def test_authorization_patch_service_invalid_token(self, test_data):
        """Check patching a servcie with an invalid token."""
