...
class ServiceControllerTest(base.FunctionalTest):
    ...
    @ddt.file_data("data_create_service_non_existing_flavor.json")
    def test_create_with_no_existing_flavor(self, service_json):
        # create with data of non-existent flavor, to cover up code coverage
        self.assertRaises(app.AppError, self.app.post,
                          '/v1.0/0001/services',
                          params=json.dumps(service_json),
                          headers={"Content-Type": "application/json"})
