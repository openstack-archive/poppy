...
def akamai_request(env, config):
    ...
    version_url = (
        '{0}papi/v0/properties/prp_{1}/versions/?contractId=ctr_{2}&groupId=grp_{3}')
    ...
    policy_url = (
        '{0}papi/v0/properties/prp_{1}/versions/{4}/hostnames/?contractId=ctr_{2}&groupId=grp_{3}')
