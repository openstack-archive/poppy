...
class DefaultServicesController(base.ServicesController):
    ...
    def __init__(self, manager):
        ...
        self._conf = conf
        self._conf.register_opts(DNS_OPTIONS,
                                 group=DNS_GROUP)
        self.dns_conf = self._conf[DNS_GROUP]
        self.default_sleep_time = [0]
        self.backoff = [(2**i) * 60 for i in range(0, self.dns_conf.times)]
