        ...
        for domain in service_new.domains:
            if domain.protocol == 'https' and domain.certificate == 'shared':
                ...
                if customer_domain in existing_shared_domains:
                    ...
                    shared_ssl_domain = self._generate_shared_ssl_domain(customer_domain,
                                                                         store)
                    while self.storage_controller.domain_exists_elsewhere(shared_ssl_domain,
