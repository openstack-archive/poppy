...
class ServiceController(base.ServiceBase):
    ...
    def __init__(self, driver):
        ...
        self.service_status_update_backend = (
            self.driver.service_status_update_backend)
    ...
    def create(self, service_obj, project_id):
        try:
            ...
            self.enqueue_service_status_check(project_id,
                                              service_obj.service_id)
    ...
    def enqueue_service_status_check(self, project_id,
                                     service_id):
        self.san_cert_add_job_backend.put(json.dumps(project_id, service_id))
