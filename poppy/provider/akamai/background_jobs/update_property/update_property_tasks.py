...
class PropertyUpdateVersionTask(task.Task):
...
class PropertyUpdateTask(task.Task):
    ...
    def execute(self, property_spec, new_version_number, update_info,
                update_type):
